...
# API's [AudioBufferSourceNode](https://webaudio.github.io/web-audio-api/#AudioBufferSourceNode).
#
...
# [knob](/docs/knob.html) and a [switch](/docs/switch.html)) in this application.
  ...
  $(document).ready ->
    ...
    class TapeMachine
      ...
      setupSpeedToggle: () ->
        ...
        # The [switch](/docs/switch.html) fires `normal` and `half` events. We bind
